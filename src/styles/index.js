...
const styles = {
  ...
  footer: {
    footerSection: `${setFlex(undefined,undefined,"col")} bg-black-color text-white-color py-10 px-5`,
    title1: "text-2xl font-bold mb-5",
    title2: "text-xl font-semibold mb-5",
    sections: `${setFlex("start","start","col",3)} w-60 h-64 border-b border-gray-800 xs:border-none`,
